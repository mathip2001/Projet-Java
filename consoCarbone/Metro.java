...
public class Metro extends Train {
    // Attributs
    private boolean utilise; // un boolean indiquant si l'utilisateur.rice utilise le métro

    // Constructeur
    public Metro(boolean utilise, int kilomAnnee) {
        super(kilomAnnee);
     ...
     * le métro en tant que moyen de transport
     * 
     * @return true si l'utilisateur utilise le métro, false sinon
     */
    ...
    public String toString() {
        return super.toString() + "\n" + "Le mode de transport est le métro : utilise=" + utilise;
    }
}
