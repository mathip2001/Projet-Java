...
public class Avion extends Transport {
    ...
    // Constructeur
    /**
     * Permet de construire un objet issu de la classe Avion
     * @param utilise représente la situation d'utilisation ou non de l'avion par l'utilisateur.rice
     * @param kilomAnnee représente le nombre de kilomètres parcourus en avion par an par l'utilisateur.rice 
