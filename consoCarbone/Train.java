...
public abstract class Train extends Transport {
    // Attributs
    protected boolean utilise; // un boolean indiquant si l'utilisateur.rice utilise un objet qui hérite de la
                               // classe Train
     ...
     * 
     * @return true si l'utilisateur utilise un objet qui hérite de Train, false
     *         sinon
     */
